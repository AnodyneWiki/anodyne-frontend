...
<div style="margin-left: 10px; padding-left: 10px; border-left: 1px solid var(--border-color-base); max-width: 50%; float:right"><div class=collapser>
<h2>Index<span class=collapseButton>&nbsp;{{template "exnd" $v.Collapse}}</span></h2>
...
<div class=collapser>
<h2>Core Ideas{{template "pexnd" $v.Collapse}}</h2>
    <div class=collapserContent>
<ul>
...
<div class=collapser>
<h2>Links{{template "pexnd" $v.Collapse}}</h2>
<div class=collapserContent>
<ul>
...
<div class=collapser>
<h2>Related Projects{{template "pexnd" $v.Collapse}}</h2>
    <div class=collapserContent>
<ul>
