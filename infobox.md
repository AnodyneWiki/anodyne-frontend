...
{{with $dosrg.Tiers.Common}}<tr><th class="InfoboxLabel">Common</th><td class="common InfoboxData">{{.Lower}}{{if lt .Lower .Upper}} - {{.Upper}}{{end}} {{.Unit}}{{if .Entries}}<span class=float-right>({{.Entries}}x{{with .Percentage}} - {{.}}%{{end}})</span>{{end}}</td></tr>{{end}}
{{with $dosrg.Tiers.Strong}}<tr><th class="InfoboxLabel">Strong</th><td class="strong InfoboxData">{{.Lower}}{{if lt .Lower .Upper}} - {{.Upper}}{{end}} {{.Unit}}{{if .Entries}}<span class=float-right>({{.Entries}}x{{with .Percentage}} - {{.}}%{{end}})</span>{{end}}</td></tr>{{end}}
{{with $dosrg.Tiers.Heavy}}<tr><th class="InfoboxLabel">Heavy</th><td class="heavy InfoboxData">{{$dosrg.Tiers.Heavy.Lower}}{{if lt .Lower .Upper}} - {{.Upper}}{{end}} {{.Unit}}{{if .Entries}}<span class=float-right>({{.Entries}}x{{with .Percentage}} - {{.}}%{{end}})</span>{{end}}</td></tr>{{end}}
{{with $dosrg.Tiers.Extreme}}<tr><th class="InfoboxLabel">Extreme</th><td class="extreme InfoboxData">{{.Lower}}{{if lt .Lower .Upper}} - {{.Upper}} {{.Unit}}{{else}} {{.Unit}} +{{end}}{{if .Entries}}<span class=float-right>({{.Entries}}x{{with .Percentage}} - {{.}}%{{end}})</span>{{end}}</td></tr>{{end}}
</table>
