...
There are currently {{if gt (len (get $vars "Erowid Experience Reports")) 25}}25+{{else}}{{len (get $vars "Erowid Experience Reports")}}{{end}} experience reports involving {{lower $vars.Title}} on <a class=logo href=https://www.erowid.org/experiences/exp.cgi>Erowid</a>:
